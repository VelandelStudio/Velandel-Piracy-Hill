...
namespace emotitron.InputSystem
{
	...
	public class CustomInputTouchZones : InputSelectionBaseDrawer
	{
		public override void OnGUI(Rect r, SerializedProperty property, GUIContent label)
		{
			...
			touchZones.intValue = (int)(TouchZones)EditorGUI.EnumMaskPopup(new Rect(secondFieldLeft, r.yMin, halfFieldWidth, 16), GUIContent.none, (TouchZones)touchZones.intValue);
